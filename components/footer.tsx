...
export function Footer() {
  ...
  const socialLinks = [
    ...
    { href: "mailto:info@keppler.pro", icon: Mail, label: "Email" },
  ]
            ...
            <div className="mt-4 flex items-center gap-3">
              {socialLinks.map((social) => (
                <a
                  ...
                  className="flex h-9 w-9 items-center justify-center rounded-full bg-secondary text-muted-foreground transition-all hover:bg-primary hover:text-primary-foreground hover:scale-110"
                >
